...
function t02 () {
    let num2 = +document.querySelector('.i-2').value;
    if(num2 > 1500){
...
function t03 () {
    let num3 = +document.querySelector('.i-3').value;
    if(num3 > 0){
...
function t05 () {
    let num5 = +document.querySelector('.i-5').value;
    if(num5){
...
function t06 () {
    let num6 = document.querySelector('.i-6').value;
    num6.length > 10 ? document.querySelector('.out-6').textContent = true : document.querySelector('.out-6').textContent = false;
}
...
function t07 () {
    let num71 = +document.querySelector('.i-71').value;
    let num72 = +document.querySelector('.i-72').value;
    if(num71 > num72){
        document.querySelector('.out-7').textContent = num71;
    }else if(num71 < num72){
        document.querySelector('.out-7').textContent = num72;
    }else if(num71 === num72){
        document.querySelector('.out-7').textContent = num71;
    }
}
...
function t09 () {
    ...
    if(num9 >= 1 && num9 <= 36) document.querySelector('.out-9').textContent = 1;
    else if  (num9 >= 37 && num9 <= 87) document.querySelector('.out-9').textContent = 2;
    else if  (num9 >= 88 && num9 <= 110) document.querySelector('.out-9').textContent = 3;
    else document.querySelector('.out-9').textContent = 0;
}
...
function t10 () {
    let range = +document.querySelector('.r-10').value;
    if(range >= 20 && range <= 30) document.querySelector('.out-10').textContent = 'cold';
    else if  (range >= 31 && range <= 50) document.querySelector('.out-10').textContent = 'warm';
    else if  (range >= 51 && range <= 70) document.querySelector('.out-10').textContent = 'hot'; 
}
...
function t11 () {
    let name = document.querySelector('.i-111').value;
...
function t16 () {
    ...
    if(text.length < 5) document.querySelector('.out-16').style.backgroundColor = 'red';
    else if(text.length >= 5 && text.length <= 10) document.querySelector('.out-16').style.backgroundColor = 'orange';
    else if(text.length > 10) document.querySelector('.out-16').style.backgroundColor = 'green';
     document.querySelector('.out-16').textContent = text;
}
...
function t19() {
    ...
    if(ch19.checked){
        document.querySelector('.out-19').textContent = 1;
    }else{
        document.querySelector('.out-19').textContent = 0;
    }
}
...
function t20() {
    ...
    if(ch20.checked){
        ...
        document.querySelector('.out-20').textContent = 0;
    }
}
