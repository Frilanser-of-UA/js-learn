...
function t01() {
	...
	document.querySelector('.out-1').textContent = i1;
}
...
function t04() {
	...
	document.querySelector('.out-4').textContent = i41 + i42;
}
...
function t05() {
	...
	document.querySelector('.i-5').value = i51;
}
...
function t06() {
	...
	document.querySelector('.out-6').textContent = i6;
}
...
function t07() {
	...
	document.querySelector('.out-7').textContent = i7;
}
...
function t08() {
	...
	document.querySelector('.p-8').value = i8;
	document.querySelector('.out-8').textContent = i8;
}
...
function t11() {
	...
	document.querySelector('.i-111').value = i11;
}
...
function t12() {
	let s12 = document.querySelector(".s-12").value;
	document.querySelector('.out-12').textContent = s12;
}
...
function t13() {
	let s13 = document.querySelector(".s-13 option[selected]").textContent;
	document.querySelector('.out-13').textContent = s13;
}
...
function t15() {
	...
	document.querySelector(".out-15").textContent = s15;
}
...
function t16() {
	let s161 = document.querySelector(".s-161").value;
	document.querySelector(".s-162").value = s161;
}
...
function t17() {
	let ta17 = document.querySelector(".ta-17").value;
	document.querySelector(".out-17").textContent = ta17;
}
...
function t18() {
	...
	document.querySelector(".out-18").textContent = i18;
}
