...
function t14(classEl, styleEl){
    const out14 = document.querySelector(classEl);
    out14.style.backgroundColor = styleEl;
}
...
function t15 (userName15){
    const out15 = document.querySelector('.out-15');
    const a15 = document.createElement('a');
    a15.href = '/logout';
    a15.textContent = userName15;
    a15.classList.add('button', 'button-primary');
    out15.append(a15);
}
...
function t16 (userName16){
    const a16 = document.createElement('a');
    a16.textContent = userName16;
    a16.classList.add('button', 'button-primary');
    a16.href = '/logout';
   return a16;
}
...
function t18(classInput){
    let i18 = +document.querySelector(classInput).value;
    return i18;
}
...
function t19(num1, num2, sing){
    let operation = eval(num1 + sing + num2);
    return operation;
}
